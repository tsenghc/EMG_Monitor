...
class Firework:
    ...
    def __init__(self):
        ...
        self.colours = (
            ...
            (randint(0, 255), randint(0, 255), randint(0, 255)))
        self.firework = Particle(randint(0, DISPLAY_WIDTH), DISPLAY_HEIGHT+100, True,
...
def main():
    ...
    while running:
        clock.tick(60)
        #font = pygame.font.SysFont("TaipeiSansTCBeta-Bold.ttf", 24)
        font = pygame.font.Font("TaipeiSansTCBeta-Bold.ttf", 42)  # 本文主角

        text1 = font.render("國立高雄科技大學智慧商務系", True, (255, 255, 255), (0, 0, 0))
        text2 = font.render("歡迎松山家商參訪", True, (255, 255, 255), (0, 0, 0))
        ...
        win.blit(text1, (30, 200))
        win.blit(text2, (120, 300))
